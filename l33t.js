...
let vapPoke = new AllPokemon(134);
let joltPoke = new AllPokemon(135);
let flarePoke = new AllPokemon(136);
let pokeDex = [];

let l33t = new PokeTrainer(pokeDex);
...
// let gbSound = document.querySelector("#gb-start");
// function playStart() {
//   gbSound.play();
// }
